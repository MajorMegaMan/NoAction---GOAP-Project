...
public class RecipePlanningExplorerWindow : BasePlanningExplorerWindow<RecipePlateAction>
{
    ...
    {
        RecipePlanningExplorerWindow wnd = GetWindow<RecipePlanningExplorerWindow>();
